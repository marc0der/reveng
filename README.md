...
**Only use this plugin with source material your organisation permits sending to a third-party LLM provider.** Reverse-engineering input often contains sensitive code, business logic, or personal data — confirm the appropriate classification or handling rules with your organisation before proceeding.
